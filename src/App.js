	...
	render() {
		return (
			<div className='app-wrap'>
				<AppTitle mainTitle={<h2>reac<span className='the-u'>U</span>l<span className='the-8'>8</span>r</h2>} subTitle='a simple calculator, built with ReactJS' />
				<div className="App">
					<div className="display-wrap">
						<DigitalDisplay>
							<DisplayCurrent stateObj={this.state} displayValue={this.state.visible_display_string}/>
							<DisplayHistory historyValue={this.state.visible_history_string} previousHistory={this.state.previous_operation_history_array.join("")}/>
						</DigitalDisplay>
					</div>
					<Keypad>
						<div className='H4 W3'>
